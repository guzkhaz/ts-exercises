...
export function requestCoffeeMachineQueueLength(
    ...
    callback({
        status: 'error',
        message: 'Numeric value has exceeded Number.MAX_SAFE_INTEGER.',
    });
}
...
function startTheApp(callback: (error: Error | null) => void) {
    requestAdmins((adminsResponse) => {
        ...
        if (adminsResponse.status === 'success') {
            ...
            return callback(new Error(adminsResponse.message));
        }
        ...
        requestUsers((usersResponse) => {
            ...
            if (usersResponse.status === 'success') {
                ...
                return callback(new Error(usersResponse.message));
            }
            ...
            requestCurrentServerTime((serverTimeResponse) => {
                ...
                if (serverTimeResponse.status === 'success') {
                    ...
                    return callback(new Error(serverTimeResponse.message));
                }
                ...
                requestCoffeeMachineQueueLength((coffeeMachineQueueLengthResponse) => {
                    ...
                    if (coffeeMachineQueueLengthResponse.status === 'success') {
                        ...
                        return callback(new Error(coffeeMachineQueueLengthResponse.message));
                    }
